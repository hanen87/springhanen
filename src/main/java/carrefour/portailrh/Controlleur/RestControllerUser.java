...
import carrefour.portailrh.common.DeviceProvider;
...
import carrefour.portailrh.security.TokenHelper;
import carrefour.portailrh.security.auth.JwtAuthenticationRequest;
...
public class RestControllerUser {
  ...
  //  @RequestMapping("/register")
   ...
   // }
    ...
    @RequestMapping("/register1/{idetab}")
    public ResponseEntity<?> register1(@RequestBody  User user,@PathVariable long idetab )
    {
        Etablissemnt e=iEtablissement.findOne((idetab));
        user.setEtablissement(e);
        Authority authority=new Authority();
        authority.setName("USER");
        iAuthority.save(authority);
    ...
    @GetMapping("/getone")
    public User listuserbyMatricule(String matricule){

        return iUser.findByUsermatricule(matricule);
    }
